                        ...
                        <div className="flex items-center justify-between w-full">
                          <div className="flex flex-col gap-1 items-start text-left max-w-[220px]">
                            <div className="flex items-center gap-2 w-full">
                              <span className="text-[12px] font-bold text-slate-700 tracking-wide truncate">{link.title}</span>
                              {link.clicks !== undefined && link.clicks > 0 && (
                                <span className="inline-flex items-center px-1.5 py-0.5 rounded-md text-[8px] font-black bg-slate-100 text-slate-500 border border-slate-200/50">
                                  {link.clicks} CLICKS
                                </span>
                              )}
                            </div>
